        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <Input
                    ...
                    className="border-construction-gray focus:border-primary"
                  />
                </div>
                <div>
          ...
          <div className="space-y-6">
            {contactInfo.map((info, index) => {
              ...
              return (
                <Card key={index} className="shadow-card-custom hover:shadow-elevated transition-all duration-300 hover:-translate-y-1">
                  <CardContent className="p-6">
                    <div className="flex items-center space-x-4">
                      ...
                      <div className="flex-1">
                        <h3 className="text-lg font-semibold text-construction-dark mb-1">
                          {info.title}
                        </h3>
                        <a
                          href={info.href}
                          ...
                          className="text-construction-gray-dark hover:text-primary transition-colors"
                        >
                          {info.content}
                        </a>
                      </div>
