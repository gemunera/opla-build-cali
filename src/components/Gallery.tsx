          ...
          <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
            ...
            {selectedProject && (
              <div className="space-y-8">
                {/* Mostrar contenido solo para "Diseño de casas y apartamentos" (índice 0) */}
                {projects.findIndex(p => p === selectedProject) === 0 && (
                  <>
                ...
                {/* Para "Diseños comercial, oficina y bodegas" (índice 1) - contenido vacío, listo para nuevos proyectos */}
                {projects.findIndex(p => p === selectedProject) === 1 && (
                  <div className="text-center py-8">
                    <p className="text-construction-gray-dark">Contenido en preparación...</p>
                  </div>
                )}

                {/* Sexto proyecto: CAF Alberto Galindo - Solo para otros índices */}
                {projects.findIndex(p => p === selectedProject) >= 2 && (
                  <div className="space-y-6">
                    <h3 className="text-xl font-semibold text-construction-dark">
                      CAF Alberto Galindo
                    </h3>
