        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, projectIndex) => <Card key={projectIndex} className="overflow-hidden shadow-card-custom hover:shadow-elevated transition-all duration-300 hover:-translate-y-2 flex flex-col h-full">
              ...
              <CardContent className="p-6 flex flex-col flex-grow">
                ...
                <Button variant="outline" className="w-full border-primary text-primary hover:bg-primary hover:text-white mt-auto" onClick={() => openModal(project)}>
                  {t('gallery.knowMore')}
                </Button>
              </CardContent>
            </Card>)}
            ...
            {selectedProject && <div className="space-y-8">
                ...
                <div className="space-y-6">
                  ...
                  <div className="relative">
                    <Carousel className="w-full">
                      <CarouselContent>
                        {['/lovable-uploads/a15298d1-f0f6-4c72-951f-1c30633ee370.png', '/lovable-uploads/0ac60b32-17d3-43b9-a2d2-0c5cca6a555f.png', '/lovable-uploads/310b8617-f29c-44dc-918a-44f3b61d94b4.png', '/lovable-uploads/a429a50a-be25-4f01-a32e-97cc4b72c375.png'].map((image: string, index: number) => <CarouselItem key={index}>
                            <div className="aspect-video overflow-hidden rounded-lg">
